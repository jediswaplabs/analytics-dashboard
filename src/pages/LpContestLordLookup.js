...
import LpContestLordLeaderboard from '../components/LpContestLordLeaderboard'
import LpContestLordNftClaim from '../components/LpContestLordNftClaim'
import { AutoRow, RowBetween } from '../components/Row'
import { Banner } from '../components/Banner'
import { AutoColumn } from '../components/Column'
import LpContestLordNftCategories from '../components/LpContestLordNftCategories'

import { useLpContestLordPlayersData } from '../contexts/LpContestLordData'
...
function LpContestLordLookup() {
  const allPlayersData = useLpContestLordPlayersData()
        ...
        >
          ...
          <LeaderboardGridRow style={{ marginTop: '25px' }}>
            <AutoColumn>
              ...
              <LpContestLordLeaderboard players={allPlayersData} />
            </AutoColumn>
            <AutoColumn gap={'20px'} style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
              <div>
                <LpContestLordNftCategories />
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
                <LpContestLordNftClaim style={{ flexGrow: '1' }}></LpContestLordNftClaim>
              </div>
            </AutoColumn>
          </LeaderboardGridRow>
        </div>
...
export default withRouter(LpContestLordLookup)
