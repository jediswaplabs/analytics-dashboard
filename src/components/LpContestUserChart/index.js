...
import { useLpContestUserLiquidityChart } from '../../contexts/User'
...
const LpContestUserChart = ({ account }) => {
  const chartData = useLpContestUserLiquidityChart(account)
    ...
    <ChartWrapper>
      <>
          {below600 ? (
              ...
              <RowBetween mb={40}>
                <AutoRow gap="10px">
                {/*  <TYPE.main>Contest points chart</TYPE.main>*/}
                </AutoRow>
                <AutoRow justify="flex-end" gap="4px">
                  <OptionButton active={timeWindow === timeframeOptions.ALL_TIME}>
                    All
                  </OptionButton>
                </AutoRow>
              </RowBetween>
...
export default LpContestUserChart
