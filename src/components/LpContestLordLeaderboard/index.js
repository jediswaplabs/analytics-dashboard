...
function LpContestLordLeaderboard({ history, players, maxItems = 10 }) {
  ...
  const handleAccountSearch = useCallback(
    (e) => {
      ...
      history.push('/lp-contest-lord/' + checkAccountQuery)
    },
    ...
    return (
      <DashGrid style={{ height: '48px' }} focus={true}>
        ...
        <DataText area="name" fontWeight="500" justifyContent="flex-start">
          <CustomLink style={{ whiteSpace: 'nowrap', marginRight: '15px' }} to={'/lp-contest-lord/' + player.user.id}>
...
export default withRouter(LpContestLordLeaderboard)
